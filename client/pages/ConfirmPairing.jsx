      ...
      <>
        { this.state.showModal
          ? <div className="ui active modal mini centered accept-modal">
              <div className="header">{ this.state.activityObject ? 'Activity Accepted' : 'Activity Created' }</div>
              <div className="content">
                <p>{this.state.activityObject ? `You are matched with ${this.state.activityObject.firstName} to go to ${this.state.activityObject.location}!` : 'Your activity has been created and once someone accepts it, will appear in your matches section.'}</p>
              </div>
